...
* Addition of **related** property to the CHRepository structure of type _List<RelatedItemModel>_.
* Addition of structure **RelatedItemModel** that contains the information of the related project in DataHub.
