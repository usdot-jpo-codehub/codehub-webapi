...
* Addition of **configurations** end point, that provides the option of getting the list of **categories** or a single category identified by its ID (see: **CHCategory**).
* Addition of **categories** to **CHCodehubData**
